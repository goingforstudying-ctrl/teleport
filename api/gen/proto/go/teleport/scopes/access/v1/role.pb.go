...
type KubeResource struct {
	...
	Kind string `protobuf:"bytes,1,opt,name=kind,proto3" json:"kind,omitempty"`
	// The resource namespace. It supports wildcards.
	Namespace string `protobuf:"bytes,2,opt,name=namespace,proto3" json:"namespace,omitempty"`
	// The resource name. It supports wildcards.
	Name string `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	// The allowed Kubernetes verbs for interacting with the Kubernetes Resource.
	Verbs []string `protobuf:"bytes,4,rep,name=verbs,proto3" json:"verbs,omitempty"`
	// The Kubernetes API group of the Kubernetes resource. It supports wildcards.
