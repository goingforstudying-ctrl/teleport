...
| --------------------- | ---------------- | ----------------------------------------------------------------- | --------------------------------------------------------------------- |
| `identity`            | identity         | name **or** alias                                                 | Users, bots. Legacy alias: `user`.                                    |
...
query can show you a *subset* of reality (RFD 318, "Paths are scoped to your
query"). This is the single most important semantic to get right:
