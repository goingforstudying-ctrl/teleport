...
Validate an AWS OIDC integration by calling AWS STS GetCallerIdentity.

Usage:

```code
$ tctl aws test-oidc --integration=INTEGRATION
```
...
|Flag|Default|Description|
|---|---|---|
|`--integration`|*no default*|Name of the AWS OIDC integration to test.|
