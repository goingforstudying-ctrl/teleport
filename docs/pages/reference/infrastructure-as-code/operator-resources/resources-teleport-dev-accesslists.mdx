...
|traits|[object](#specgrantstraits)|traits are the traits to be granted to users.|
...
|traits|[object](#specmembership_requirestraits)|traits are the traits that must be present for the user to obtain access.|
...
|traits|[object](#specowner_grantstraits)|traits are the traits to be granted to users.|
...
|---|---|---|
|roles|[]string|roles are the user roles that must be present for the user to obtain access.|
|traits|[object](#specownership_requirestraits)|traits are the traits that must be present for the user to obtain access.|
