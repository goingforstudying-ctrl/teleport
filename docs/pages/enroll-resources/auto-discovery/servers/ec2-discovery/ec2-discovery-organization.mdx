...
- Credentials and IAM permissions to create roles and policies in each AWS
  account that has resources you want to enroll with your Teleport cluster.
...
1. Define a trust relationship that allows the Discovery Service to assume the
   role you just defined. Execute the following command in the shell where you
   retrieved the Discovery Service role ARN earlier:
